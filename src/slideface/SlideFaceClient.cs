...
namespace SlideFace
{
    public class SlideFaceClient : ISlideFaceClient
    {
        private readonly ILogger<SlideFaceClient> _logger;
        private readonly HttpClient _http;

        public SlideFaceClient(IOptions<SlideFaceOptions> options, ILogger<SlideFaceClient> logger)
        {
            _logger = logger;
