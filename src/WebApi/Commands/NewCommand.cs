...
namespace Slidable.Commands
{
    public class NewCommand
    {
        ...
        public async Task Execute()
        {
            ...
            await Write(Empty.slidable_json, "slidable.json");
            ...
            Console.WriteLine("Edit slides.md to create your Slidable presentation.");
            Console.WriteLine("Edit slidable.json to configure settings.");
        }
