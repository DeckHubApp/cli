...
namespace Deck.Commands
{
    public class NewCommand
    {
        ...
        public async Task Execute()
        {
            ...
            await Write(Empty.deckhub_json, "deckhub.json");
            ...
            Console.WriteLine("Edit slides.md to create your Deck presentation.");
            Console.WriteLine("Edit deckhub.json to configure settings.");
        }
